...
export interface DataTableProps<Row = any> { columns: DataTableColumn<Row>[]; rows: Row[]; rowKey?: string; sortKey?: string; sortDir?: "asc" | "desc"; onSort?: (key: string, dir: "asc" | "desc") => void; density?: "standard" | "compact"; stickyHeader?: boolean; maxHeight?: number | string; loading?: boolean; error?: string | boolean; emptyNode?: React.ReactNode; onRetry?: () => void; minWidth?: number; caption?: string; /** 展開中の行キー。renderExpanded と併用 */ expandedKeys?: Array<string | number>; renderExpanded?: (row: Row) => React.ReactNode; style?: React.CSSProperties; }
